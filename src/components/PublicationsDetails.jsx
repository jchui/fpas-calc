                ...
                <div className="question">
                    ...
                    <div className="radios">
                        <input
                            ...
                            defaultChecked={handleDefaultChecked(this.props.values.publications, 0)} />
                        ...
                        <input
                            ...
                            id="r2"
                            onChange={this.props.handleChange('publications')}
                            defaultChecked={handleDefaultChecked(this.props.values.publications, 1)} />
                        <label className="radio" htmlFor="r2">
                            <p><strong>x1</strong> Educational research paper published in a peer-reviewed journal with a PubMed ID number
                        ...
                        <input
                            ...
                            id="r3"
                            onChange={this.props.handleChange('publications')}
                            defaultChecked={handleDefaultChecked(this.props.values.publications, 2)} />
                        <label className="radio" htmlFor="r3">
                            <p><strong>More than 1</strong> Educational research paper published in a peer-reviewed journal with a PubMed ID number
